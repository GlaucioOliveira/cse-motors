...
CREATE TABLE public.review (
	review_id int4 GENERATED ALWAYS AS IDENTITY NOT NULL,
...
ALTER TABLE public.review ADD CONSTRAINT review_account_fk FOREIGN KEY (account_id) REFERENCES public.account(account_id) ON DELETE CASCADE;
ALTER TABLE public.review ADD CONSTRAINT review_inventory_fk FOREIGN KEY (inv_id) REFERENCES public.inventory(inv_id) ON DELETE CASCADE;